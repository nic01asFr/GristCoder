...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    "    * RAFRAICHIR apres ecriture : utilise grist.docApi.applyAndFetch(actions, 'MaTable') qui ECRIT puis renvoie DIRECTEMENT les lignes a jour (tableau d'objets) -> mets-les dans ton state et re-render. N'utilise PAS grist.onRecords pour rafraichir une table que l'artefact ecrit lui-meme : il ne se declenche pas (le widget est lie a une autre table).",
