...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    "- HABILLE TES ECRANS. Aucune CSS n'est injectee : un artefact sans style s'affiche en HTML brut, texte noir sur fond blanc, boutons par defaut — inutilisable en demonstration. Mets un <style> (artefact html) ou un objet de styles (React) au debut de CHAQUE artefact. Le minimum vital : police systeme, marges, titre lisible, tableau a lignes alternees, boutons avec fond et rayon, etat vide explicite. Reste sobre et coherent d'un ecran a l'autre — meme palette, memes espacements. Socle possible : font-family system-ui,sans-serif ; texte #1a1a1a ; accent #3e5de7 ; bordures #e2e8f0 ; rayon 6px ; padding 12px.",
